...
class Trajectory_comp(ExplicitComponent):
    ...
    def compute(self, inputs, outputs):
        ...
        while dico_events_stage_1['MECO']['actif'] == False and dico_events_stage_1['impact']['actif'] == False  :
...
#        ######################## 2nd stage ##########################
    ...
    #            
            ...
            while (dico_events_stage_2['SECO']['actif'] == False and dico_events_stage_2['impact']['actif'] == False) and current_T[-1]<tf2 :
