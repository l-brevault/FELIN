...
class Dry_Mass_stage_1_Comp(ExplicitComponent):
    ...
    def compute(self, inputs, outputs):
        ...
        M_thrust_frame = mmf.thrust_frame_mass(Total_Thrust/inputs['N_eng_stage_1'][0]/1000,M_eng/inputs['N_eng_stage_1'][0],Constants['NX_max_dim'],inputs['N_eng_stage_1'][0],Constants['Thrust_frame_material'],Constants['SSM_TF_1st_stage'])
        ...
        V_Ox = M_OX / mu_LOX
        V_FT = M_F / mu_F
        M_FT,M_OxT,M_TPS_OxT,M_TPS_FT,M_intertank = mmf.tank_mass(inputs['Pdyn_max_dim'][0],Constants['NX_max_dim'],Constants['P_tank_Ox'],Constants['P_tank_F'],V_FT,V_Ox,inputs['Diameter_stage_1'][0],S_Ox,S_F,2*S_dome,S_totale,Constants['Type_prop'],Constants['Tank_config'],Constants['Stage_in_staging'],Constants['Type_struct_intertank'])
        ...
        M_interstage = mmf.mass_interstage(Constants['S_interstage'],inputs['Diameter_stage_1'][0],inputs['Diameter_stage_2'][0],Constants['Type_interstage'])
